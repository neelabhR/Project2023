                ...
                <div class="row" id="installment_form">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->monthly_payments?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-8 control-label"><?=lang('no_of_payments')?></label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->quarterly_payments?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-8 control-label"><?=lang('no_of_payments')?></label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->semi_annually_payments?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-8 control-label"><?=lang('no_of_payments')?></label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->annually_payments?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-8 control-label"><?=lang('no_of_payments')?></label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->biennially_payments?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-8 control-label"><?=lang('no_of_payments')?></label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" value="<?=$item->triennially_payments?>"
