...
--
-- Host: localhost:3306
-- Generation Time: Jul 11, 2021 at 09:14 PM
...
--
-- Table structure for table `hd_account_details`
--
...
--
-- Dumping data for table `hd_plugins`
--

INSERT INTO `hd_plugins` (`plugin_id`, `system_name`, `name`, `category`, `status`, `uri`, `version`, `description`, `author`, `author_uri`, `config`) VALUES
(5, 'cpanel', 'cPanel', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'cPanel API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(6, 'directadmin', 'Directadmin', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'Directadmin API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(7, 'plesk', 'Plesk', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'Plesk API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(8, 'ispconfig', 'ISPConfig', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'ISPConfig API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(9, 'cwp', 'CWP', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'Centos Web Panel API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(10, 'cyberpanel', 'Cyberpanel', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'Cyberpanel API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(11, 'interworx', 'Interworx', 'Servers', 0, 'http://www.hostingbilling.net', '1.0', 'Interworx API Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(12, 'bitcoin', 'Bitcoin', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Bitcoin Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(13, 'checkout', 'Checkout', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', '2Checkout Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(14, 'coinpayments', 'Coinpayments', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Coinpayments Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(15, 'domainscoza', 'Domainscoza', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Domains Registrar Integration', 'Hosting Billing', 'www.hostingbilling.net', ''),
(16, 'hexonet', 'Hexonet', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Hexonet Registrar Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(17, 'instamojo', 'Instamojo', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Instamojo Payment Gateway', 'Hosting Billing', 'www.hostingbilling.net', ''),
(18, 'internetbs', 'Internetbs', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Internt.bs Registrar Integration', 'Hosting Billing', 'www.hostingbilling.net', ''),
(19, 'mollie', 'Mollie', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Mollie Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(20, 'namecheap', 'Namecheap', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Namecheap Registrar Integration', 'Hosting Billing', 'www.hostingbilling.net', ''),
(21, 'payfast', 'Payfast', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Payfast Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(22, 'paypal', 'Paypal', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Paypal Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(23, 'paystack', 'Paystack', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Paystack Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(24, 'razorpay', 'Razorpay', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Razorpay Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(25, 'resellerclub', 'Resellerclub', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'ResellerClub Registrar Integration', 'Hosting Billing', 'www.hostingbilling.net', ''),
(26, 'stripepay', 'Stripepay', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'Stripepay Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(27, 'whoisxmlapi', 'Whoisxmlapi', 'Domain Availability', 0, 'http://www.hostingbilling.net', '1.0', 'Whois XML API Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(28, 'aamarpay', 'aamarPay', 'Payment Gateways', 0, 'http://www.hostingbilling.net', '1.0', 'aamarPay Payment Gateway.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(29, 'namesilo', 'Namesilo', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Namesilo Registrar Integration.', 'Hosting Billing', 'www.hostingbilling.net', ''),
(30, 'synergywholesale', 'SynergyWholesale', 'Domain Registrars', 0, 'http://www.hostingbilling.net', '1.0', 'Synergy Wholesale Registrar Integration.', 'Hosting Billing', 'www.hostingbilling.net', '');
