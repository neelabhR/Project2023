                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="registrar">
                                                ...
                                                <option value="resellerclub" <?=($account->registrar == 'resellerclub') ? 'selected' : ''?>>ResellerClub</option>
                                                <option value="namecheap" <?=($account->registrar == 'namecheap') ? 'selected' : ''?>>Namecheap</option>
                                                <option value="domainscoza" <?=($account->registrar == 'domainscoza') ? 'selected' : ''?>>DomainsCoZa</option>
                                            </select>
                                            </div>
                                        </div>
