...
$email['user'] = array("hosting_account","activate_account","change_email","forgot_password","registration","reset_password");
...
?>
    <div class="row">
       ...
       <a href="<?=base_url()?>settings/?settings=templates&group=<?=$template_group;?>&email=<?=$temp;?>" class="<?php if($setting_email == $temp){ echo "active"; } ?> btn btn-s-xs btn-sm btn-twitter"><?=lang($lang)?></a>
                            <?php endforeach; ?>
